...
class ClosedPositionTests(DjangoModelTestCaseBase):
    ...
    def closedposition_fidelity_individual_spaxx_lot23():
        return ClosedPosition(
            ...
            cost_basis_price=Decimal("57.347"), cost_basis_total=Decimal("13.190"), proceeds_price=Decimal("57.347"),
            proceeds_total=Decimal("13.190"), short_term_pnl=Decimal("0"), long_term_pnl=Decimal("0"),
            cost_basis_price_unadj=Decimal("81.913"), cost_basis_total_unadj=Decimal("18.84"),
            short_term_pnl_unadj=Decimal("-5.65"), long_term_pnl_unadj=Decimal("0"))
    ...
    def closedposition_fidelity_individual_spaxx_lot11177():
        return ClosedPosition(
            ...
            cost_basis_price=Decimal("74.872"), cost_basis_total=Decimal("8368.55"), proceeds_price=Decimal("57.336"),
            proceeds_total=Decimal("6408.47"), short_term_pnl=Decimal("-1960.08"), long_term_pnl=Decimal("0"),
            cost_basis_price_unadj=Decimal("81.93"), cost_basis_total_unadj=Decimal("9157.32"),
            short_term_pnl_unadj=Decimal("-2748.85"), long_term_pnl_unadj=Decimal("0"))
